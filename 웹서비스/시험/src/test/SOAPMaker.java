...
public class SOAPMaker {
	...
	public void setParameter(String sequence, DataObject object) {
		String parameter = "<arg"+sequence+">";
		String keys[] = object.getKeys();

		for(int i=0;i<keys.length;i++)
			parameter=parameter+"<"+keys[i]+">"+object.getValue(keys[i])+"</"+keys[i]+">";
...
*/
	public void setParameterArrayListObject(String sequence, ArrayList<DataObject> list) throws Exception{
